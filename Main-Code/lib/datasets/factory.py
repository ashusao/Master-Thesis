...
stateDetection_devkit_path = './data/stateDetection'
for split in ['train', 'val']:
        name = '{}_{}'.format('stateDetection', split)
        __sets[name] = (lambda split=split: stateDetection(split, stateDetection_devkit_path))
